<template>
    <div class="wrapper">
        <div v-for="(item, index) in data" :key="index" class="cards__con d-inline-block mr-5 mb-5">
            <v-card class="cards_card d-flex flex-row align-center justify-space-around px-5" max-width="370" min-width="370" height="75" style="border: 1px solid #ddd;box-shadow: none;">
